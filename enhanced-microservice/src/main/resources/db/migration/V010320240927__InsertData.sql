...
insert into tour  (tour_package_code, title, description, blurb, bullets, difficulty, duration, price, region, keywords) values
  ...
  (
    ...
    'Cycle California your way! Choose a route, length and distance that fits your skill level, take advantage of our partnership with the AMGEN tour, and a group of riders with common interests. We tailor this package for you, down to the mile.',
    'Cycling is a fantastic way to see California and Cycle California: My Way is a customizable package that celebrates that fact. Guided and unguided routes are available and, as with all our packages, we tailor the outings to your comfort and skill level. This is a great package for families who want to see California outside of a car (and traffic!). The most popular variety is the 6-day Monterey to Santa Barbara tour but this year only, we’re also offering a special package this year that allows serious cyclists to follow behind a competitor in the AMGEN bike race, a race that mimics the conditions in the Tour de France. Spots are limited so call now to reserve your seat now!\nChoose your level of experience, desired distance, and location and we''ll give you a call back to plot your route and confirm your reservation.',
    'Choose a route, length, and distance that fits your skill level, Ride behind the Amgen Tour, See sites from San Diego to Monterey, Travel with a dedicated guide and road crew',
   'Varies',
    'Varies',
    '1200',
    'Varies',
  ...
  (
    'DS',
    'Mojave to Malibu',
    'Join us for one of Explore California''s exclusive ''motorcades,'' Mojave to Malibu - a motorcycle tour from the outskirts of the Mojave desert down to the Malibu coast.',
    'Only experienced road hogs need apply! The tour group will meet at Old Glory Motorcycle Company in Lancaster, CA to retrofit and get ready for the day''s ride. The pack takes the Angeles Crest Highway, through Angeles National Forest, stopping at biker-friendly Newcomb Ranch for drinks and grub. Winding your way down through L.A., You''ll take a side trip through Griffith Park, home of the observatory and that classic scene from Rebel without a Cause. After cruising Hollywood Boulevard, the tour makes its way through Santa Monica, through Topanga Canyon and ends in Malibu, where you can grab world-class seafood and burgers from the roadside diner, Paradise Cove Beach Cafe.',
    'Motorcycle from Lancaster to Malibu, Views of the Angeles National Forest, Side trip through Griffith Park, Dinner at a roadside diner in Malibu',
   'Difficult',
    '1 day',
    '200',
    'Southern California',
  ...
  (
    ...
    'Dive into the pages of Scot O''Dell''s classic children''s novel and visit the Channel Islands, namesake of the Island of the Blue Dolphins. The Channel Islands are a natural playground for kids, and offer an unique and fascinating look into the history of California.',
    'The Island of the Blue Dolphins Tour starts with a ferry from beautiful Ventura to the Channel Islands, home of the ''Lone Woman of San Nicolas Island,'' who was the inspiration for the Newbery Medal winning children''s book. Your Island Packers ferry guide will point out local fish and fauna, and the right time of year, you might even catch a glimpse of a dolphin or a blue whale. Once onshore, hike and look out for the herd of wild buffalo housed on Santa Catalina. Also keep an eye peeled for the endangered island fox. Enjoy a kid-friendly picnic lunch prepared by the Avalon Beach Cafe at the botanical gardens or climb to one of the islands''high points and survey the California coast from the perspective of the heroine. On the trip back to land, the ferry stops in Santa Barbara, and You''ll have the chance to visit the famous mission where Karana lived after being rescued. One last stop for salt taffy and knick knacks at the pier and the ferry will deliver you safely back to Ventura, with your own copy of the book to take home and read as a family.',
    'Ferry from Ventura to the Channel Islands, Admission to the state parks, Kid-friendly organic picnic, Stoll through the Catalina Botanical Gardens, Ferry to Santa Barbara and tour of the Santa Barbara Mission',
   'Easy',
    '1 day',
    '200',
    'Southern California',
  ...
  (
    'KC',
    'Eco-Tour',
    'Want to pass on a healthy environment to the next generation? Want to teach them how to preserve it too? Take the Explore California Eco-Tour and travel responsibly, along the way learning about both nature and nurturing.',
    'At Explore California, we strive to have all our tours be ecologically sound, by serving organic food, using low emissions vehicles, and working with small businesses, but this tour is designed specifically to explore why we take those measures. This 3-day trip has families in mind, but is great for any outdoor enthusiast/activist. The first day, You''ll kayak the creeks surrounding Lake Casitas in Ventura County, all the way to the ocean. A victim of drought and mismanagement, it is now federally protected and you can watch it coming back to life. The first night will be spent at the Ojai Foundation, in your choice of a yurt or cabin. The second day is spent on an organic farm in Ojai, California, touring the grounds and learning about organic farming methods. Spend a night in town at a kid and pet friendly bed and breakfast. The third day, You''ll travel up the coast to Santa Barbara to visit the botanical gardens and Natural History Museum and learn about California''s endangered species. Before you leave, take a guided hiked of the foothills above the coast. If nothing else, the views will leave a lasting impression on you of just how valuable the environment is.',
    'Kayak from fresh water creeks to the Pacific Ocean, Spend the night in a yurt, Learn about growing produce on an organic farm, Admission to the Santa Barbara Botanical Gardens and Natural History Museum',
   'Medium',
    '3 days',
    '750',
    'Southern California',
  ...
  (
    ...
    'Mountain High was established in 1929, but continues to be among the top five mountain resorts in the state. Experience what draws hundreds of thousands of visitors to this snow destination each season. The Mountain High Lift-off is the weekender''s ski spectacular, perfect for couples who need a retreat.',
    'Mountain High is only an hour from Los Angeles, but once you arrive, You''ll feel like you''re in another world. The Mountain High Lift-off is the weekender''s ski spectacular, perfect for couples who need a retreat, featuring two days of premium runs with an all access Express Lift ticket, available exclusively through Explore California. No more waiting in line and guaranteed admittance even when the resort sells out. Accommodations are provided at the Larks Nest Cabin, a vintage charmer featuring a stone fireplace, clawfoot tub, and full kitchen. Dine at the Wrightwood Inn''s cozy mountain pub, or grab a sandwich from the Evergreen Cafe and Raccoon Saloon. Equipment rental and transportation from Los Angeles International Airport is included.',
    '2 day lift ticket with Express Pass, 2 nights at a vintage cabin with stone fireplace and clawfoot tub, Equipment rental included, Luxury transportation from LAX',
   'Difficult',
    '3 days',
    '800',
    'Southern California',
  ...
  (
    'TC',
    'A Week of Wine',
    'Spend a week in wine country. Watch the evolution of a wine from harvesting to corking, in the heart of Sonoma Valley, considered the birthplace of wine-making in California.',
    'Immerse yourself in the culture and lifestyle of a California winery. Spend 5 days in your private guest villa at the Stockbridge Winery, located in scenic Sonoma. You''ll spend your days wandering the vineyards, touring the presses and cellars, and assisting staff in making America''s favorite wine. Enjoy Tuscan-style meals served al fresco, overlooking the gorgeous countryside. Day trips include dinner in Sausalito, hiking in the redwood forests, and lunch in downtown San Francisco.',
    'Winery and vineyard tours, Nightly tastings, Country breakfast, Private lodging, Special dinner in Sausalito, Day tour of San Francisco, Hiking in Mt. Hood National Park',
   'Easy',
    '5 days',
    '850',
